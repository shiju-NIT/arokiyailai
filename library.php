                                                ...
                                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-card"><img class="product-card-img-top" width="240" height="240" src=<?=$image_location?> alt="<?=$row['image']?>">
                                                        <div class="product-card-body">
                                                            <h5 class="product-title"><?=$row['disease_name']?></h5>
                                                            
                                                            
                                                            
                                                            <div class="product-actions"><a href="disease_detail.php?d_id=<?=$row['id']?>"><button class="btn btn-success">Click for Symptoms</button></a>
</div>
                                                        </div>
                                                    </div>
                                                </div>
