                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card gradient-dark-grey">
                                <div class="card-header">
                                    <div class="card-title">Get More Insights about Cotton Pest Diseases</div>
                                </div>
                                ...
                                if($d_id!=NULL){ $sql = "SELECT * FROM `pest_disease` WHERE `id`=$d_id";}
                                else
                                {
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        $identificationArray = explode('.', $row['identification']);
                                        $cultural_practicesArray = explode('.', $row['cultural_practices']);
                                            ...
                                            <div class="card gradient-dark-grey2">
                                                <div class="card-body">
                                                    <div class="row gutters">
                                                        ...
                                                        <div class="card-title"><?=$row['pest_name']?></div>
...
<?php
foreach ($identificationArray as $iden) {
?>
<ul class="bullet-list">
    <li><h5 class="product-title"><?php echo htmlspecialchars($iden)?></h5></li>
</ul>
<?php
}
?>
<div class="card-title">cultural practices</div>
<?php
foreach ($cultural_practicesArray as $culp) {
?>
<ul class="bullet-list">
    <li><h5 class="product-title"><?php echo htmlspecialchars($culp)?></h5></li>
</ul>
<?php
}
?>
...
?>
                                                        ...
                                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                                            <div class="product-list-card">
                                                                <h5><?=$row['pest_name']?></h5>
                                                                <img class="product-list-img" width="300" height="300" src="<?=$image_location?>" alt="<?=$row['pest_name']?>">
