...
if(empty($id)){
    $sql = "INSERT INTO `schedule_list` (`title`,`description`,`start_datetime`,`end_datetime`,`flower`,`backdrop`,`bouquet`) VALUES ('$title','$description','$start_datetime','$end_datetime','$flower_name','$backdrop_name','$bouquet_name')";
}else{
