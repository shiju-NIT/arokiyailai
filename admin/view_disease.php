			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">View Disease</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						...
						<li class="active"><span>View disease</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
				...
				<div class="row">
									...
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="example" class="table table-hover display  pb-30" >
												...
												<?php
												$i=1;
					$query="SELECT * FROM `disease` where `status`=1";
					...
					?>
										<tr>
									   <td><?php echo $i++;?></td>
									   <td><img src="disease/<?php echo $disease_details_array['image']?>" width="100%" height="100%" alt="Product Image" /></td>
                                       <td><?php echo $disease_details_array['disease_name']?></td>
                                       <td><?php echo $disease_details_array['symptoms']?></td>
                                       <td><?php echo $disease_details_array['survival']?></td>
                                       <td><?php echo $disease_details_array['f_condition']?></td>
                                       <td><?php echo $disease_details_array['management']?></td>
                                       <td class="text-nowrap"><a href="update_vendor.php?id=<?php echo $disease_details_array['id']?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a> <a href="?id=<?php echo $disease_details_array['id']?>" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a> </td>
