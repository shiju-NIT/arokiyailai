...
if(empty($_FILES['image']['name'])){
    ...
    $res=$con->query("UPDATE `pest_disease` SET `pest_name`='$pest_name',`symptoms`='$symptoms',`identification`='$identification',`cultural_practices`='$cultural_practices',`management`='$management' WHERE `id`='".$_GET['id']."'");
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Update pest Diseases</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>Update pest Diseases</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<?php
											$p_disease=mysqli_query($con,"SELECT * FROM `pest_disease` where `id`='".$_GET['id']."'")or die(mysqli_error($con));
                                    		$pest=mysqli_fetch_array($p_disease);
											?>
											<form action="#" method="post" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="disease_name" value="<?php echo $pest['pest_name']?>" class="form-control" name="pest_name" placeholder="Enter the pest Disease Name" required>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<textarea class="form-control" value="<?php echo $pest['symptoms']?>" rows="4" name="symptoms" placeholder="Symptoms Details"></textarea>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<textarea class="form-control" rows="4" value="<?php echo $pest['identification']?>" name="identification" placeholder="Identification pest and Biology Life Cycle"></textarea>
														</div>
													</div>
												</div>	
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<textarea class="form-control" value="<?php echo $pest['cultural_practices']?>" rows="4" name="cultural_practices" placeholder="Cultural Practices"></textarea>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<textarea class="form-control" value="<?php echo $pest['management']?>" rows="4" name="management" placeholder="Management"></textarea>
														</div>
													</div>
												</div>
