                            ...
                            <div class="card gradient-dark-grey">
                                ...
                                <div class="card-body">
                                    <div class="row gutters">
                                        ...
                                        $sql = "SELECT * FROM camera WHERE user_id=$user_id";
                                        ...
                                        ?>
                                                ...
                                                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="product-card"><img class="product-card-img-top" src=<?=$image_location?> width="240" height="240" alt="<?=$row['camera']?>">
                                                        <div class="product-card-body">
                                                            ...
                                                            ?>
                                                            <h5 class="product-title"><?php echo $prediction['disease_name']?></h5>
                                                            
                                                            <div class="product-rating">
                                                                
                                                                <div class="total-ratings"><?=$row['created_on']?></div>
                                                            </div>
                                                            
                                                            <div class="product-actions"><a href="disease_report.php?d_id=<?=$row['prediction']?>&usr_id=<?=$row['id']?>"><button class="btn btn-success ">Check Suggestions</button></a></div>
